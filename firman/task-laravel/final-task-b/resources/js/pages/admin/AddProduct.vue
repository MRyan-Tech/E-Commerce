...
const schema = yup.object({
    ...
    stock: yup.number().required("Stok wajib diisi").min(0, "Stok tidak boleh bernilai negatif"),
    price: yup.number().required("Harga tidak boleh kosong").min(0, "Harga tidak boleh bernilai negatif"),
    description: yup.string().required("Descripsi harus diisi"),
    category: yup.string().required("String harus diisi"),
    image: yup.mixed().required("Gambar tidak boleh kosong").test("filetype", "Format gambar harus JPG, JEPG, PNG", (value) => {
                    ...
                    <div class="card-body">
                        ...
                        <form @submit.prevent="addProduct">
                            <div class="mb-3 mx-5">
                                ...
                                <input v-model="productName" type="text" class=" form-control" id="product_name" name="product_name" :class="{ 'is-invalid' : errors.product_name}">
                                ...
                                <div class="row mb-3">
                                    <div class=" col-md-6">
                                        ...
                                        <input v-model.number="stock" type="number" min="0" class=" form-control" id="stock" name="stock" :class="{'is-invalid' : errors.stock}">
                                    ...
                                    <div class=" col-md-6">
                                        ...
                                        <input v-model.number="price" type="number" id="price" class=" form-control" name="price" :class="{'is-invalid' : errors.price}">
                                ...
                                <div class=" mb-3">
                                    ...
                                    <textarea v-model="description" class=" form-control" name="description" id="description" :class="{'is-invalid' : errors.description}"></textarea>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="file" class=" form-control" id="image" name="image" accept="image/jpeg, image/png, image/jpg" @change="handleFileChange" :class="{'is-invalid' : errors.image}">

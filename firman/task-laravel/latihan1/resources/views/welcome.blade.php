...
<html dir="ltr" lang="en">
  <head>
    ...
    />
    <!-- Custom CSS -->
    <link href="{{ asset('clone/assets/libs/flot/css/float-chart.css')}}" rel="stylesheet" />
    <!-- Custom CSS -->
  ...
  <body>
              ...
              <div class="card">
                ...
                <div class="comment-widgets scrollable">
                  ...
                  <div class="d-flex flex-row comment-row mt-0">
                    <div class="p-2">
                      <img
                        src="{{ asset('clone/assets/images/users/1.jpg')}}"
                        alt="user"
                        width="50"
                  ...
                  <div class="d-flex flex-row comment-row">
                    <div class="p-2">
                      <img
                        src="{{ asset('clone/assets/images/users/4.jpg')}}"
                        alt="user"
                        width="50"
                        class="rounded-circle"
                      />
                  ...
                  <div class="d-flex flex-row comment-row">
                    <div class="p-2">
                      <img
                        src="{{ asset('clone/assets/images/users/5.jpg')}}"
                        alt="user"
                        width="50"
                        class="rounded-circle"
                      />
                        ...
                        <ul class="list-style-none assignedto">
                          ...
                          <li class="assignee">
                            <img
                              class="rounded-circle"
                              width="40"
                              src="{{ asset('clone/assets/images/users/2.jpg')}}"
                              alt="user"
                              data-toggle="tooltip"
                              data-placement="top"
                              title=""
                          ...
                          <li class="assignee">
                            <img
                              class="rounded-circle"
                              width="40"
                              src="{{ asset('clone/assets/images/users/3.jpg')}}"
                              alt="user"
                              data-toggle="tooltip"
                              data-placement="top"
                              title=""
                ...
                <div class="card-body">
                  ...
                  <div class="chat-box scrollable" style="height: 475px">
                    ...
                    <ul class="chat-list">
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="{{ asset('clone/assets/images/users/1.jpg')}}" alt="user" />
                        </div>
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="{{ asset('clone/assets/images/users/2.jpg')}}" alt="user" />
                        </div>
                        <div class="chat-content">
                      ...
                      <li class="chat-item">
                        <div class="chat-img">
                          <img src="{{ asset('clone/assets/images/users/3.jpg')}}" alt="user" />
                        </div>
                        <div class="chat-content">
                ...
                <div class="tab-content tabcontent-border">
                  <div class="tab-pane active" id="home" role="tabpanel">
                    <div class="p-20">
                      ...
                      <img
                        src="{{ asset('clone/assets/images/background/img4.jpg')}}"
                        class="img-fluid"
                      />
                    </div>
                  </div>
    ...
    <!-- Charts js Files -->
    <script src="{{ asset('clone/assets/libs/flot/excanvas.js')}}"></script>
    <script src="{{ asset('clone/assets/libs/flot/jquery.flot.js')}}"></script>
    <script src="{{ asset('clone/assets/libs/flot/jquery.flot.pie.js')}}"></script>
    <script src="{{ asset('clone/assets/libs/flot/jquery.flot.time.js')}}"></script>
    <script src="{{ asset('clone/assets/libs/flot/jquery.flot.stack.js')}}"></script>
    <script src="{{ asset('clone/assets/libs/flot/jquery.flot.crosshair.js')}}"></script>
    <script src="{{ asset('clone/assets/libs/flot.tooltip/js/jquery.flot.tooltip.min.js')}}"></script>
    <script src="{{ asset('clone/js/pages/chart/chart-page-init.js')}}"></script>
  </body>
</html>

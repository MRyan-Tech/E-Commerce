...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>MamanShop Admin</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
      sizes="16x16"
      href="{{ asset('clone/assets/images/favicon.png')}}"
    />
    <!-- Custom CSS -->
    <link
      rel="stylesheet"
      type="text/css"
      href="{{ asset('clone/assets/libs/select2/dist/css/select2.min.css')}}"
    />
    <link
      rel="stylesheet"
      type="text/css"
      href="{{ asset('clone/assets/libs/jquery-minicolors/jquery.minicolors.css')}}"
    />
    <link
      rel="stylesheet"
      type="text/css"
      href="{{ asset('clone/assets/libs/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')}}"
    />
    <link
      rel="stylesheet"
      type="text/css"
      href="{{ asset('clone/assets/libs/quill/dist/quill.snow.css')}}"
    />
    <link href="{{ asset('clone/css/style.min.css')}}" rel="stylesheet" />
  ...
  <body>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{ asset('clone/assets/libs/jquery/dist/jquery.min.js')}}"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="{{ asset('clone/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js')}}"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="{{ asset('clone/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js')}}"></script>
    <script src="{{ asset('clone/assets/extra-libs/sparkline/sparkline.js')}}"></script>
    <!--Wave Effects -->
    <script src="{{ asset('clone/js/waves.js')}}"></script>
    <!--Menu sidebar -->
    <script src="{{ asset('clone/js/sidebarmenu.js')}}"></script>
    <!--Custom JavaScript -->
    <script src="{{ asset('clone/js/custom.min.js')}}"></script>
    <!-- This Page JS -->
    <script src="{{ asset('clone/assets/libs/inputmask/dist/min/jquery.inputmask.bundle.min.js')}}"></script>
    <script src="{{ asset('clone/js/pages/mask/mask.init.js')}}"></script>
    <script src="{{ asset('clone/assets/libs/select2/dist/js/select2.full.min.js')}}"></script>
    <script src="{{ asset('clone/assets/libs/select2/dist/js/select2.min.js')}}"></script>
    <script src="{{ asset('clone/assets/libs/jquery-asColor/dist/jquery-asColor.min.js')}}"></script>
    <script src="{{ asset('clone/assets/libs/jquery-asGradient/dist/jquery-asGradient.js')}}"></script>
    <script src="{{ asset('clone/assets/libs/jquery-asColorPicker/dist/jquery-asColorPicker.min.js')}}"></script>
    <script src="{{ asset('clone/assets/libs/jquery-minicolors/jquery.minicolors.min.js')}}"></script>
    <script src="{{ asset('clone/assets/libs/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')}}"></script>
    <script src="{{ asset('clone/assets/libs/quill/dist/quill.min.js')}}"></script>
    <script>
      //***********************************//
      // For select 2
      //***********************************//

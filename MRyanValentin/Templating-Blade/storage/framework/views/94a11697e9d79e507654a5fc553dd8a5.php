  ...
  <head>
    <meta charset="utf-8">
      ...
      <!-- Favicon -->
        ...
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/backend.css?v=1.0.2')); ?>">
        ...
        <link rel="stylesheet" href="<?php echo e(asset('assets/vendor/@icon/dripicons/dripicons.css')); ?>">
        </head>
    ...
    <div class="wrapper">
      ...
      <div class="iq-sidebar  sidebar-default ">
          <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
              ...
              <img src="<?php echo e(asset('assets/images/logo.png')); ?>" class="img-fluid light-logo" alt="logo">
          ...
          <div class="iq-navbar-custom">
              ...
              <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                  ...
                  <img src="<?php echo e(asset('assets/images/logo.png')); ?>" class="img-fluid  light-logo" alt="logo"><h5 class="logo-title ml-3 mt-1">EmailCHIMP</h5>
...
<div class="container-fluid">
         ...
         <a href="page-activity.html" title="">
            <div class="media iq-option border align-items-center p-3">
               <div class="bg-warning-light rounded p-4">
                  <img src="<?php echo e(asset('assets/images/options/08.png')); ?>" class="img-fluid avatar-50" alt="image">
               </div>
               <div class="media-body">
   ...
   <!-- Page end  -->
    ...
    <script src="<?php echo e(asset('assets/js/vector-map-custom.js')); ?>"></script>
...
<?php /**PATH /Users/yogahermawan/Development/LIB/Vue-Laravel/MRyanValentin/Templating-Blade/resources/views/welcome.blade.php ENDPATH**/ ?>
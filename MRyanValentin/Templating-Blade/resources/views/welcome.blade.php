  ...
  <head>
    <meta charset="utf-8">
      ...
      <!-- Favicon -->
        ...
        <link rel="stylesheet" href="{{ asset('assets/css/backend.css?v=1.0.2') }}">
...
>>>>>>> 9ee5bad53cc6a96f72ccfeb2f99b8c0b77a42adf
          ...
          <div class="iq-navbar-custom">
              ...
              <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                  ...
                  <img src="{{ asset('assets/images/logo.png') }}" class="img-fluid  light-logo" alt="logo"><h5 class="logo-title ml-3 mt-1">EmailCHIMP</h5>
         ...
         <a href="page-activity.html" title="">
            <div class="media iq-option border align-items-center p-3">
               <div class="bg-warning-light rounded p-4">
                  <img src="{{ asset('assets/images/options/08.png')}}" class="img-fluid avatar-50" alt="image">
               </div>
               <div class="media-body">

...
<div class="card shadow">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive" style="height: 100%; overflow-y: auto; position: relative;">
                        ...
                        <form class="form-kategori">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_subkategori" id="id_subkategori" class="form-control">
                                    ...
                                    <option value="<?php echo e($category->id); ?>"><?php echo e($category->nama_subkategori); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\E-commerce\resources\views/product/index.blade.php ENDPATH**/ ?>
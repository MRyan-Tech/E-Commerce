                                ...
                                <div class="logo-container">
                                    <div class="logo-wrap">
                                        <a href="/">
                                            ...
                                            ?>
                                            <img class="logo-dark2" src="/uploads/<?php echo e($about->logo); ?>" alt="logo">
                                                    ...
                                                    <div class="megamenu-wrap container">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3 megamenu-item">
                                                                <ul class="menu-list">
                                                                    <li>
                                                                        <span><?php echo e($category->nama_kategori); ?></span>
                                                                    </li>
                                                                    <?php
                                                                    $subcategories =
                                                                    ...
                                                                    <li>
                                                                        <a
                                                                            href="/products/<?php echo e($subcategory->id); ?>"><?php echo e($subcategory->nama_subkategori); ?></a>
                                                                    </li>
                            ...
                            <div class="flex-child flex-right nav-right hidden-sm hidden-xs">
                                <ul>
                                    <li class="nav-register">
                                        <?php if(Auth::guard('webmember')->check()): ?>
                                        <a href="/profile"><?php echo e(Auth::guard('webmember')->user()->nama_member); ?> </a>
                                        <?php else: ?>
                                    ...
                                    <li class="nav-cart">
                                        <div class="nav-cart-outer">
                                            <div class="nav-cart-inner">
                                                <a href="/cart" class="fa fa-shopping-cart" style="color: black"></a>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="nav-register">
                                        <?php if(Auth::guard('webmember')->check()): ?>
                                        <a href="/logout_member" class="fa-solid fa-right-from-bracket">Logout</a>
                                        <?php endif; ?>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12">
                                <div class="widget footer-about-us">
                                    <h1 class="widget-title bottom-line left-align grey">Gadget Zone Store</h1>
                                    <p class="mb-30">Gadget Zone Store is a store that sells electronic products</p>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-6 copyright sm-text-center">
                                <span>
                                    &copy; 2025 Created by <a href="/front/#">M Ryan</a>
                                </span>
                            </div>
...
</style><?php /**PATH C:\laragon\www\E-commerce\resources\views/layout/home.blade.php ENDPATH**/ ?>
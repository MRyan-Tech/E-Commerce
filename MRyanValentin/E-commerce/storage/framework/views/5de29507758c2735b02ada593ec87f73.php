        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/kategori">Master Kategori</a>
                        <a class="collapse-item" href="/subkategori">Master Subkategori</a>
                        <a class="collapse-item" href="/slider">Master Slider</a>
                        <a class="collapse-item" href="/barang">Master Barang</a>
            ...
            <div class="container my-auto "style="margin-top: 100px">
                    <div class="copyright text-center my-auto">
                        <span>Create by: &copy; M Ryan 2025</span>
                    </div>
                </div>
        </ul>
        <!-- End of Sidebar -->
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">M Ryan </span>
...
<?php /**PATH C:\laragon\www\E-commerce\resources\views/layout/app.blade.php ENDPATH**/ ?>
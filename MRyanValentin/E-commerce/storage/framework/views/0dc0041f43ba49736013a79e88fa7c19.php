...
<section class="section-wrap shopping-cart">
    <div class="container relative">
        <form class="form-cart">
            <input type="hidden" name="id_member" value="<?php echo e(Auth::guard('webmember')->user()->id); ?>">
            <div class="row">
                <div class="col-md-12">
                    <div class="table-wrap mb-30">
                        <table class="shop_table cart table">
                            ...
                            <tbody>
                                ...
                                <input type="hidden" name="id_produk[]" value="<?php echo e($cart->product->id); ?>">
                                <input type="hidden" name="jumlah[]" value="<?php echo e($cart->jumlah); ?>">
                                ...
                                <tr class="cart_item">
                                    <td class="product-thumbnail">
                                        <a href="#">
                                            <img src="/uploads/<?php echo e($cart->product->gambar); ?>" alt="">
                                        </a>
                                    </td>
                                    <td class="product-name">
                                        <a href="#"><?php echo e($cart->product->nama_barang); ?></a>
                                        <ul>
                                            <li>Size: <?php echo e($cart->size); ?></li>
                                            <li>Color: <?php echo e($cart->color); ?></li>
                                        </ul>
                                    </td>
                                    <td class="product-price">
                                        <span class="amount"><?php echo e("Rp. " . number_format($cart->product->harga)); ?></span>
                                    </td>
                                    <td class="product-quantity">
                                        <span class="amount"><?php echo e($cart->jumlah); ?></span>
                                    </td>
                                    <td class="product-subtotal">
                                        <span class="amount"><?php echo e("Rp. " . number_format($cart->total)); ?></span>
                                    </td>
                                    <td class="product-remove">
                                        <a href="/delete_from_cart/<?php echo e($cart->id); ?>" class="remove"
                ...
                <div class="col-md-6 shipping-calculator-form">
                    ...
                    <p class="form-row form-row-wide">
                        <select name="provinsi" id="provinsi" class="country_to_state provinsi"
                            ...
                            <?php $__currentLoopData = $provinsi->rajaongkir->results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provinsi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($provinsi->province_id); ?>"><?php echo e($provinsi->province); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </p>
                    <p class="form-row form-row-wide">
                        ...
                        <table class="table shop_table">
                            <tbody>
                                <tr class="cart-subtotal">
                                    <th>Cart Subtotal</th>
                                    <td>
                                        <span class="amount cart-total"><?php echo e($cart_total); ?></span>
                                    </td>
                                </tr>
                                <tr class="shipping">
                                    <th>Shipping</th>
...
<?php echo $__env->make('layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\E-commerce\resources\views/home/cart.blade.php ENDPATH**/ ?>
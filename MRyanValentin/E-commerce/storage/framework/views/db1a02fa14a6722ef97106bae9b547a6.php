    ...
    <div class="flex shadow w-full flex-col-reverse lg:flex-row">
        <div class="w-full lg:w-1/2 bg-white p-10 px-5 md:px-20">
            ...
            <ul>
                ...
                <li style="color: red"><?php echo e($error[0]); ?></li>
            ...
            <p style="color: red"><?php echo e(Session::get('failed')); ?></p>
            <?php endif; ?>
...
<?php /**PATH C:\laragon\www\E-commerce\resources\views/auth/login_member.blade.php ENDPATH**/ ?>
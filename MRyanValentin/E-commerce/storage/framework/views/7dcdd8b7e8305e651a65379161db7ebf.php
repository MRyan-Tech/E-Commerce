        ...
        <div class="row">
            ...
            <div class="ecommerce col-xs-12">
                ...
                <form name="checkout" class="checkout ecommerce-checkout row" method="POST" action="/payments">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="id_order" value="<?php echo e($orders->id); ?>">
                                    ...
                                    <tr class="order-total">
                                        ...
                                        <td>
                                            <strong><span class="amount">Rp.
                                                    <?php echo e(number_format($orders->grand_total)); ?></span></strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <ul class="payment_methods methods">
                                    ...
                                    <li class="payment_method_bacs">
                                        ...
                                        <div class="payment_box payment_method_bacs">
                                            ...
                                            <p>Atas Nama : <?php echo e($about->atas_nama); ?></p>
                                            <p>No Rekening : <?php echo e($about->no_rekening); ?></p>
                                        </div>
                                    </li>
                                </ul>
...
<?php echo $__env->make('layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\E-commerce\resources\views/home/checkout.blade.php ENDPATH**/ ?>
...
<section class="section-wrap promo-banners pb-30">
    ...
    <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
        <a href="#">
            <img src="/uploads/{{$category->gambar}}" alt="" style="width:360px; height:570px; background-color:rgb(105, 105, 105)">
                ...
                <div class="product-item hover-trigger">
                    <div class="product-img">
                        <a href="/front/shop-single.html">
                            <img src="/uploads/{{$product->gambar}}" alt="" style=" width:262px; height:350px; background-color:rgb(105, 105, 105)">
                        </a>

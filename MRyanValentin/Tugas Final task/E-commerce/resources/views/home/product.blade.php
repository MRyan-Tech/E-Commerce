        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xs-12 product-slider mb-60">
                ...
                <div class="flickity flickity-slider-wrap mfp-hover" id="gallery-main">
                    ...
                    <div class="gallery-cell">
                        <a href="/uploads/{{$product->gambar}}" class="lightbox-img" style="width:262px; height:400px; background-color:rgb(105, 105, 105)">>
                            <img src="/uploads/{{$product->gambar}}" alt="" style="width:262px; height:400px; background-color:rgb(105, 105, 105)">/>
                            <i class="ui-zoom zoom-icon"></i>
                        </a>
                    </div>
                    ...
                    <div class="product-item hover-trigger">
                        <div class="product-img">
                            <a href="/product/{{$produk->id}}">
                                <img src="/uploads/{{$produk->gambar}}" alt="" style="width:262px; height:400px; background-color:rgb(105, 105, 105)">>
                                <img src="/uploads/{{$produk->gambar}}" alt="" class="back-img" style="width:262px; height:400px; background-color:rgb(105, 105, 105)">
                            </a>
